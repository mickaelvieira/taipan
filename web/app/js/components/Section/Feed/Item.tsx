...
export default withStyles(styles)(React.memo(function FeedItem({ index, bookmark, classes }: Props) {
  const divRef = useRef(null);
  const visible = index < 5 ? true : useIsVisible(divRef)
  const image = bookmark.image && visible
    ? bookmark.image.url
